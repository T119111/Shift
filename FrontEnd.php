...
echo "<h1 class='text-center text-info my-4'>日程を入力する期間を指定して下さい</h1>";
//formの始まり
echo "<form action='input.php' method='POST'>";
//名前をselectボックスで選択する
echo "氏名 ： <select name='name' class='form-control'>";
//employeeテーブルに格納されている従業員をすべて表示する
...
echo "日程入力開始日：<input type='date' name='start' class='form-control'><br>";
echo "日程入力終了日：<input type='date' name='end' class='form-control'><br>";
